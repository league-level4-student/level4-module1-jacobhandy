...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		switch(input) {
		case 0: timer.setDelay(3);
		case 1: timer.setDelay(5);
		case 2: timer.setDelay(7);
		}
		//3. start the timer
		timer.start();
	}
	...
	private void setFoodLocation() {
		...
		if(snake.isLocationOnSnake(l)) {
			l = new Location(new Random().nextInt(WIDTH), new Random().nextInt(HEIGHT));
		}
		else {
			foodLocation = l;
		}
